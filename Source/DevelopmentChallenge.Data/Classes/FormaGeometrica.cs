...
namespace DevelopmentChallenge.Data.Classes
{
    public class FormaGeometrica
    {
        ...
        public virtual decimal CalcularArea() { return 0; }

        public virtual decimal CalcularPerimetro() { return 0; }
        ...
        public static string Imprimir(List<FormaGeometrica> formas, int idioma)
        {
            ...
            else
            {
                ...
                sb.Append(new FormaGeometrica().ObtenerLinea(numeroCuadrados, areaCuadrados, perimetroCuadrados, 1, idioma));
                sb.Append(new FormaGeometrica().ObtenerLinea(numeroCirculos, areaCirculos, perimetroCirculos, 3, idioma));
                sb.Append(new FormaGeometrica().ObtenerLinea(numeroTriangulos, areaTriangulos, perimetroTriangulos, 2, idioma));
        ...
        public virtual string TraducirFormaEspaniol(int cantidad) { return ""; }

        public virtual string TraducirFormaIngles(int cantidad) { return ""; }
